...
public class GetCompanyInfoByIdEndpointTest
{
    private readonly Mock<IMediator> _mockMediator;
    private readonly Mock<ILogger<CompanyController>> _mockLogger;
    private readonly CompanyController _companyController;

    public GetCompanyInfoByIdEndpointTest()
    {
    ...
    [Fact]
    public async Task Should_Return_CompanyInfoById_WithOkStatusCode()
    {
        var companyId = 1;
        var query = new GetCompanyInfoByIdQuery(companyId);

        var expectedResponse = new CompanyByIdResponseModel
        {
            Id = companyId,
        ...
        // Act
        var result = await _companyController.GetCompanyInfoByIdAsync(companyId);
        ...
        var returnedValue = okResult.Value.ShouldBeOfType<CompanyByIdResponseModel>();
    ...
    public async Task Should_Return_NotFound_When_CompanyDoesNotExist()
    {
        ...
        // Act
        var result =  _companyController.GetCompanyInfoByIdAsync(companyId);
